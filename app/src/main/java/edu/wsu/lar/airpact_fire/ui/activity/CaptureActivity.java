...
public class CaptureActivity extends AppCompatActivity
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Activity activity = CaptureActivity.this;
            if (null != activity) {
                activity.finish();
            }
        }
    ...
    /**
     * An {@link ImageReader} that handles still image captureImage.
     */
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // We done use front-facing camera.
...
//                    .show(getFragmentManager(), FRAGMENT_DIALOG);
    ...
    /**
     * Initiate a still image captureImage.
     */
    ...
    /**
     * Lock the focus as the first step for a still image captureImage.
     */
    ...
    /**
     * Unlock the focus. This method should be called when still image captureImage sequence is
     * finished.
     */
